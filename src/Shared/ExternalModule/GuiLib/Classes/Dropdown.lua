...
local ARROW_UP = "rbxassetid://3926305904"
local ARROW_DOWN = "rbxassetid://3926305904"
local ARROW_UPROT = 90
local ARROW_DOWNROT = -90
...
function init(self)
	...
	for i, optionButton in next, listFrame.ScrollFrame:GetChildren() do
		if not optionButton:IsA("TextButton") then continue end
...
function DropdownClass:Show(bool)
	...
	self.Button.Arrow.Rotation = bool and ARROW_UPROT or ARROW_DOWNROT
