...
function MathUtils:ConvertBase(Value, FromBase, ToBase)
    local oldrange = (FromBase.Max - FromBase.Min)
    local newrange = (ToBase.Max - ToBase.Min)

    return (((Value - FromBase.Min) * newrange) / oldrange) + ToBase.Min
end
